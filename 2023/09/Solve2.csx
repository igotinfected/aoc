...
{
    long[] initialValueArray = [0L, ..initialValues];
...
long GetExtrapolatedValue(List<long[]> invertedPascalsTriangle)
{
    ...
    {
        invertedPascalsTriangle[currentRowIndex][0] =
            invertedPascalsTriangle[currentRowIndex][1]
            - invertedPascalsTriangle[currentRowIndex + 1][0];
    }

    return invertedPascalsTriangle[0][0];
}
